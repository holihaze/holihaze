  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (paymentLink) {
        ...
        setGlobalError("Error: Unable to generate payment link. Please try again.") // Set global error message
      }
    } catch (error) {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  id="phone"
                  type="tel"
                  inputMode="numeric"  // Suggests numeric input on mobile devices ̰
                  {...register("phone", {
                    required: "Phone number is required",
                    pattern: {
                      value: /^[0-9]{10}$/, // Only allows 10 digits
